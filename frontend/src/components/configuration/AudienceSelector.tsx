 ...
 *
 * Compact collapsed dropdown selector for the target audience, plus an optional custom
...
export function AudienceSelector({
  ...
  const isPreset =
    value !== null &&
    AUDIENCE_OPTIONS.includes(value as (typeof AUDIENCE_OPTIONS)[number]);
    ...
    <div ref={containerRef} className="relative w-full">
      ...
      {open && (
        <div
          ...
          className="absolute left-0 top-full z-50 mt-1.5 w-full min-w-[240px] overflow-hidden rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-lg animate-in fade-in-0 zoom-in-95"
        >
